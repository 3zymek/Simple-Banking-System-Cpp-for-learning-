...
Welcome to my **Simple Banking System** project!  
This is a small C++ console app I coded myself to practice **OOP**, **vectors**, and basic input handling. It’s a part of my learning journey as I sharpen my programming skills. 🚀👨‍💻
...
- Focused on practicing good input validation and basic security (passwords and account IDs).

---

## Why this project? 📚

I'm learning C++ step-by-step and building projects like this helps me track my progress and understand how things work in practice.  
This is not a professional banking app (obviously), but it’s my playground to mess around with classes, vectors, and console I/O.  

---

## Features 🚀

- Create account with name, password, and random ID  
- Login/logout system  
- Deposit and withdraw money with input checks  
...
Compile and run with a C++ compiler (tested on GCC). You will get a menu-driven console app that guides you through the options.  

---

## What’s next? 🔜

- Improve security (password hashing, maybe)  
- Add file saving/loading for persistent accounts  
- Polish UI with colors or maybe GUI?  
- Learn and apply more advanced C++ concepts  

---
## Thanks for checking out my project! ✌️  
Feel free to follow my progress and suggest improvements.
---
```cpp
#include <iostream>
#include <string>
